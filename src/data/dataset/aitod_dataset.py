...
@register()
class AITODDetection(DetDataset):
    __inject__ = [
        "transforms",
    ]
    ...
    def __init__(
        ...
        print(
            f"[AITODDetection] Loaded {len (self .image_files )} images from {img_folder }"
        )
        print(f"[AITODDetection] Classes: {self .num_classes } - {self .class_names }")
