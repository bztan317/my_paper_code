...
class PResNet(nn.Module):
    def __init__(
        ...
        self.return_stage0 = return_stage0
        self.stage0_channels = _out_channels[0]
        self.stage0_stride = _out_strides[0]
    ...
    def forward(self, x):
        ...
        for idx, stage in enumerate(self.res_layers):
            ...
            if idx in self.return_idx:
                outs.append(x)
        if self.return_stage0:
            return {"stage0": stage0, "feats": outs}
        return outs
